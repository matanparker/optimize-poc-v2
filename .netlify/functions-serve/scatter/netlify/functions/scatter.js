...
// netlify/functions/scatter.js
var { createResponse, loadCSVData, filterByWindow, computeMetrics } = require_utils();
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const points = Object.entries(groups).map(([campaign, data]) => {
    ...
    return createResponse({ points, simulated: true });
  } catch (error) {
    console.error("Error in scatter function:", error);
