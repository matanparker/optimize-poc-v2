...
var { createResponse, mockFAQs } = require_utils();
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const matchedFaq = mockFAQs.find(
      (faq) => faq.q.toLowerCase().includes(lowerMessage) || lowerMessage.includes(faq.q.toLowerCase())
    );
    if (matchedFaq) {
      return createResponse({
        answer: matchedFaq.a,
